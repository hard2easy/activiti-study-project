package com.activiti.study.activiti.utils;
...
public class ActivitiFlowPictureUtil {
    private static final Logger logger = LoggerFactory.getLogger(ActivitiFlowPictureUtil.class);
     ...
     * @return
     */
    public static void getFlowImgByInstanceId(String processInstanceId, OutputStream outputStream, HistoryService historyService, ProcessEngineConfiguration processEngineConfiguration,RepositoryService repositoryService) {
        try {
